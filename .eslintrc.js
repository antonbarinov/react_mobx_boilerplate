module.exports = {
  ...
  "rules": {
    ...
    "dot-location": "error", // Enforce newline before and after dot - https://eslint.org/docs/rules/dot-location
    ...
    // Code style
    "array-bracket-spacing": ["error", "always"], // Disallow or enforce spaces inside of brackets - https://eslint.org/docs/rules/array-bracket-spacing
