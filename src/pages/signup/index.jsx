    ...
    return (
        <Container className={styles.container}>
            {state.submitInProgress && (
                <LoadingAnimationOverlay bluredContainerRef={bluredContainer} />
            )}
            <div ref={bluredContainer}>
                <h1>Sign up</h1>
                <div>
                    <FormFieldWrapper field={state.formFields.full_name}>
                        <FormInput placeholder="Full name" field={state.formFields.full_name} />
                    </FormFieldWrapper>
                    <FormFieldWrapper field={state.formFields.login}>
                        <FormInput placeholder="Login" field={state.formFields.login} />
                    </FormFieldWrapper>
                    ...
                    <FormButton
                        onClick={state.validateAndSubmit}
                        loading={state.submitInProgress && 'Signing up...'}
                    >
                        Sign up
                    </FormButton>
